...
description: Use when building new UI or reshaping an existing one — guidance for distinctive, intentional visual design. Helps with aesthetic direction, typography, and making choices that don't read as templated defaults.
triggers: [visual design, ui design, landing page, web design, typography, hero, brand, aesthetic, design direction, styled page]
