...
triggers: [kubernetes, k8s, helm, manifest, pod, deployment, ingress, rbac, networkpolicy, namespace, kubectl, cluster, gitops]
origin: skills.sh/jeffallan/claude-skills
license: MIT
metadata:
