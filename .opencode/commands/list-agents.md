...
| Category | Agents |
|----------|--------|
| **Build / Plan** | code-architect, code-explorer, migration-planner, planner, prd-agent |
| **Review (General)** | code-quality-analyzer, code-reviewer, security-reviewer |
| **Language Reviewers** | angular-reviewer, cpp-reviewer, csharp-reviewer, flutter-reviewer, go-reviewer, java-reviewer, kotlin-reviewer, php-reviewer, python-reviewer, react-reviewer, rust-reviewer, swift-reviewer, typescript-reviewer |
...
| **Specialized** | a11y-architect, database-reviewer, docs-lookup, fastapi-reviewer, incident-responder, mle-reviewer, performance-optimizer |
| **Quality / Process** | doc-updater, e2e-runner, harness-optimizer, loop-operator, report-auditor, tdd-guide |
